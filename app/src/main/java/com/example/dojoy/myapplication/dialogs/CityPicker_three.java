 ...
 * @author zd
 */
public class CityPicker_three extends LinearLayout {
    /**
     * 滑动控件
     */
...
//	private static ArrayList<String> couny_list_code = new ArrayList<String>();
    ...
    public CityPicker_three(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        getaddressinfo();
    }

    public CityPicker_three(Context context) {
        super(context);
        this.context = context;
        getaddressinfo();
    }
    ...
    public static class JSONParser {
        ...
        public List<Cityinfo> getJSONParserResult(String JSONString, String key) {
            ...
            while (iterator.hasNext()) {
                Entry<String, JsonElement> entry = iterator
                        .next();
