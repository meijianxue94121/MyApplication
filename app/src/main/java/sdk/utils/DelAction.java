...
//
//public class DelAction implements Runnable {
//
//    /**
//     * 成功获得网络数据 ID
//     */
...
//
//    private DelParam param;
//
//    private Handler handler;
//
//    @SuppressLint("HandlerLeak")
//    public DelAction(int actionId, String url) {// baseUrlm没有参数的地址
//        this.url = url;
//        this.id = actionId;
//        handler = new Handler() {
//            @Override
...
//    }
//
//    public void setParam(DelParam param) {
//        this.param = param;
//    }
//
...
////                        }
////                    }
//                    request = new Request.Builder().url(url+ param.getRequestParam()).delete().build();
